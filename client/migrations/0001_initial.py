# Generated by Django 2.1.5 on 2019-01-13 18:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pesel', models.CharField(max_length=11, validators=[django.core.validators.RegexValidator(code='nomatch', message='Niewlasciwy PESEL!', regex='^\\d{11}$')])),
        ...
        migrations.CreateModel(
            name='City',
            fields=[
                ('postal_code', models.CharField(max_length=6, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(code='nomatch', message='Niewlasciwy kod pocztowy! Uzyj formatu XX-XXX.', regex='^\\d{2}-{1}\\d{3}$')])),
