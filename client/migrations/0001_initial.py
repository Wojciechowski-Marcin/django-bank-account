...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_number', models.CharField(max_length=26, unique=True, validators=[django.core.validators.RegexValidator(code='nomatch', message='Bledny numer rachunku', regex='^\\d{26}$')])),
                ('balance', models.DecimalField(decimal_places=2, max_digits=10)),
                ('transaction_limit', models.CharField(max_length=5, validators=[django.core.validators.RegexValidator(code='nomatch', message='Bledny limit transakcji', regex='^[0-9]$')])),
                ('currency', models.CharField(max_length=3, validators=[django.core.validators.RegexValidator(code='nomatch', message='Bledna waluta', regex='^[A-Z]{3}$')])),
                ('is_active', models.CharField(max_length=1, validators=[django.core.validators.RegexValidator(code='nomatch', message='Bledna wartosc', regex='^[0,1]{1}$')])),
                ('creation_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('account_type', models.CharField(max_length=1, validators=[django.core.validators.RegexValidator(code='nomatch', message='Bledna wartosc', regex='^[0,1]{1}$')])),
